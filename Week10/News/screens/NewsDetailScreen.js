...
function NewsDetailScreen(props) {
  ...
  const [pressed, setPressed] = useState(false); // State to manage button press

  // Function to handle header button press
  function headerButtonPressHandler() {
    setPressed(!pressed); // Toggle the button state
  }
  ...
  }, [props.navigation, headerButtonPressHandler]); // Update when navigation or button state changes
