...
import { Button, Pressable, SafeAreaView, StyleSheet, Text, TextInput, View, Modal} from 'react-native';
...
export default function App() {
  ...
  let resultText = (
    <Text style={styles.resultText}>Rolle the Dice and Make a Wager</Text>
  )
  ...
  if (userGuess !== "" && userGuessNum !== diceSumNum) {
    resultText = <Text style={styles.resultText}>Yo Lost ${userWagerNum}</Text>
  }
    ...
    <>
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.rollButtonContainer}>
          ...
          {/* <Button title="Rolle Dice" style={styles.rollButton}/> */}
        </View>
