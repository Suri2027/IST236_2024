...
function HomeScreen() {
  ...
  //states and functions for guests
  ...
  //states and functions for beds
  const bedsCounts = [1, 2, 3, 4];
  ...
  //set the results to show on the screen after the user click the Reserve Now button
  ...
  function onReserveHandler() {
    ...
    res = res + `Number of Beds:\t\t${bedsCounts[numBeds]}\n`;
    setResults(res);
  }

  //dinamically change the text for the date and the label
